            ...
            <nav class="uk-navbar">
                ...
                <div class="uk-navbar-flip">
                    <ul class="uk-navbar-nav user_actions">
                                    ...
                                    <ul id="header_alerts" class="uk-switcher uk-margin">
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                ...
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <img class="md-user-image md-list-addon-avatar" src="{{asset('public/assets/img/avatars/avatar_07_tn.png')}}" alt=""/>
                                                    </div>
                                                    <div class="md-list-content">
                                                ...
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <img class="md-user-image md-list-addon-avatar" src="{{asset('public/assets/img/avatars/avatar_09_tn.png')}}" alt=""/>
                                                    </div>
                                                    <div class="md-list-content">
                        ...
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            <a href="#" class="user_action_image"><img class="md-user-image" src="{{asset('public/assets/img/avatars/avatar_11_tn.png')}}" alt=""/></a>
